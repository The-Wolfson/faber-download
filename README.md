> [!NOTE]
> This project is for educational purposes only. Do not download music without the express permission of the publisher and composer. This project is not liable for any damadges incurred as a result of using this project.

# Faber Music PDF Downloader
...
Made in 🇦🇺 by [@The-Wolfson](https://github.com/The-Wolfson)